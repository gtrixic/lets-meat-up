...
public class PersonalityQuestionsActivity extends AppCompatActivity {
    ...
    lets.meat.up.pnAdapter pnAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pnAdapter = new lets.meat.up.pnAdapter(qns,answers,answerarray);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(allInputsFilled){
                    ...
                    Intent intent = new Intent(PersonalityQuestionsActivity.this, lets.meat.up.LoginActivity.class);
