...
public class ForgetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ForgetPasswordActivity.this, lets.meat.up.LoginActivity.class);
    ...
    public void nextPage(){ //after validating user input, pass the input to the next page of forget password
        Intent next = new Intent(ForgetPasswordActivity.this, lets.meat.up.ForgetPassword1Activity.class);
