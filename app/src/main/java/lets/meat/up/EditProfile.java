...
public class EditProfile extends AppCompatActivity {
    ...
    FirebaseAuth mAuth;
    lets.meat.up.LMUDBHandler dbhandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbhandler = new lets.meat.up.LMUDBHandler(this);
            ...
            public void onClick(View v) {
                ...
                if (allInputFilled && genderSelected != null) {
                    ...
                    if (regex.matcher(etDob.getText().toString()).matches()) {
                        ...
                        final lets.meat.up.AccountData accountData = dbhandler.returnUser(EditProfile.this);
                        ...
                        dbhandler.readData(databaseReference, new lets.meat.up.LMUDBHandler.OnGetDataListener() {
                            @Override
                            public void onSuccess(DataSnapshot dataSnapshot) {
                                ...
                                Intent intent = new Intent(EditProfile.this, lets.meat.up.UserProfile.class);
