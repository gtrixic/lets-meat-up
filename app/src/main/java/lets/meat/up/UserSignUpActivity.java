...
public class UserSignUpActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    emailQuery.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (dataSnapshot.exists() && runtime > 0) {
                                ...
                                final lets.meat.up.AccountData dbAccountData = new lets.meat.up.AccountData();
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            fireRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                ...
                                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                    ...
                                                                    Intent intent = new Intent(UserSignUpActivity.this, lets.meat.up.UserSignUp2Activity.class);
        ...
        BackButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(UserSignUpActivity.this, lets.meat.up.SignupOrLoginActivity.class);
                startActivity(intent);
            }
        });
    }
